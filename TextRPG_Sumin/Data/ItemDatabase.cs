...
public class ItemDatabase
{
    public static List<Item> Items = new List<Item>()
    {
        ...
        new Item{Name="낡은 활", Type = ItemType.Weapon, Value = 2, Description = "쉽게 볼 수 있는 낡은 활 입니다.", Price = 600, IsPurchased = false, IsEquip = false },
        new Item{Name="낡은 지팡이", Type = ItemType.Weapon, Value = 2, Description = "쉽게 볼 수 있는 낡은 지팡이 입니다.", Price = 600, IsPurchased = false, IsEquip = false },
        new Item{Name="무적 갑옷", Type = ItemType.Armor, Value = 100, Description = "던전에서 죽지 않는 무적 갑옷입니다.", Price = 100000, IsPurchased = false, IsEquip = false }
    };
}
